...
export const AddressesSection: React.FC = () => {
  ...
  const addressesData = {
    church: {
      ...
      name: "Lady of Mount Carmel's Church Kadawalagedara",
      address: 'Kadawalagedara',
      url: 'https://maps.app.goo.gl/xJm5TdEHnmdSNxbx6'
    },
    homecoming: {
      title: 'Wedding Dinner',
      name: 'Royal Dawn Banquet Hall (Srimali) Hotel',
      address: 'Srimali Hotel',
      url: 'https://maps.app.goo.gl/RVmra5veEQ1VHTnc8'
    }
  };
        ...
        <div className="w-full px-4 sm:px-12 max-w-2xl space-y-8 z-10 relative">
          ...
          >
            ...
            <div className="text-left flex-1 -mt-1.5 pb-2">
              ...
              <button
                onClick={() => handleGetDirections(addressesData.church.url)}
                id="btn-nav-church"
          ...
          >
            <div className="flex flex-col items-center">
              <div className="w-2.5 h-2.5 bg-brand-champagne rotate-45 flex-shrink-0" />
            </div>
            ...
            <div className="text-left flex-1 -mt-1.5">
              ...
              <button
                onClick={() => handleGetDirections(addressesData.homecoming.url)}
